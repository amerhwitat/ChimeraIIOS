...
static int cmd_help(const CommandContext&,int,char*const*,char*o,std::size_t n){
    out(o,n,
        ...
        "Storage: diskpart parted fdisk gdisk; use --list for read-only inspection; writes require --yes-i-really-mean-it.\n"
