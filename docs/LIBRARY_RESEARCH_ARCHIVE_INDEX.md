# Chimera II OS — Library Research Archive Index

This index records the prior research corpus used to develop Chimera II OS. The original Library files remain the source artifacts; this repository contains derived architecture, code, citations and provenance notes rather than silently replacing those files.
...
- `Chimera_II_OS_8192_High_Low_Level_Technical_Specification.pdf`
- 4096/8192/N-bit CPU simulator and RegisterN research artifacts.
- ARM Cortex-M, ARM64 and x86-64 compatibility research.
- ISA assembler/disassembler and ABI research.

## Broader source and historical research

The Library also contains source archives, historical computing references, Windows/Win32 research, Amiga material, Linux/Unix research, NLP/PDF/OCR work, and visual references. These are treated as a provenance corpus, not as a blanket redistribution license.
...
Not every Library artifact is suitable for direct publication. Before copying a file into an open-source repository, check:
...
- whether the artifact is a research reference or original Chimera implementation.

When a file is not redistributable, publish a bibliographic/provenance entry and link to the lawful original source instead of copying it.
