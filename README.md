...
The repository provides CMake and Visual Studio solutions plus GitHub Actions for the major build paths. See the relevant subdirectory README files before building a specific edition or tool.
