...
"$LD" -nostdlib -z max-page-size=0x1000 -T "$ROOT/kernel/arch/x86_64/koronos.ld" "$BUILD/entry.o" "$BUILD/io.o" "$BUILD/mode_switch.o" "$BUILD/koronos.o" "$BUILD/elf64.o" "$BUILD/module.o" "$BUILD/relocate.o" "$BUILD/arch_init.o" "$BUILD/module-test.o" -o "$BUILD/koronos.elf"
