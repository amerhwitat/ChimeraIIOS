...
int main() {
    assert(chimera_htons(0x1234) == 0x3412);
    assert(chimera_ntohs(0x3412) == 0x1234);
    assert(chimera_htonl(0x12345678u) == 0x78563412u);
    assert(chimera_ntohl(0x78563412u) == 0x12345678u);
